<?php
	...
	// Probably Unused
	$Forum_Topic_Inherit = false;
	$Forum_Topic_Default = 'Pending';
	$Forum_Reply_Inherit = false;
	...
	$Sitewide_Security_Limit = true;
	$Sitewide_Security_Limit_Time = 300;
	$Sitewide_Security_Limit_Attempts = 3;
