...
if ($Request['path'] === $Place['path'].$Canonical) {
	...
	<div class="section group">
		...
		<div class="col span_4_of_6">
			<h2>Countdown</h2>
			<iframe style="float: left; width: 270px; height: 42px; border: none;" src="https://howtoubuntu.org/count.html"></iframe>
			...
			<input class="code" type="text" value='&lt;iframe style="float: left; width: 270px; height: 42px; border: none;" src="https://howtoubuntu.org/count.html"&gt;&lt;/iframe&gt;'>
			...
			<iframe style="float: right; width: 175px; height: 62px; border: none;" src="https://howtoubuntu.org/count.html"></iframe>
			<input class="code" type="text" value='&lt;iframe style="float: left; width: 175px; height: 62px; border: none;" src="https://howtoubuntu.org/count.html"&gt;&lt;/iframe&gt;'>
