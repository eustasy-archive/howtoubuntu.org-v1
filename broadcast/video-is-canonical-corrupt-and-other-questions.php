...
if ($Request['path'] === $Place['path'].$Canonical) {
	...
	<div class="section group">
		...
		<div class="col span_3_of_5">
			...
			<p><a href="https://ww.youtube.com/nixiedoeslinux">NixiePixel</a> doesn't usually do the 'ask Nixie' type thing.. but here are some of your most commonly asked Linux / FOSS questions and her replies. || <a href="http://plus.google.com/+NixiePixel/">+NixiePixel</a></p>
			<h3 class="textcenter"><a class="download fancybox-media" href="https://ww.youtube.com/embed/KOF05L1tZaE?autohide=1&showinfo=0">Play Video</a></h3>
		</div>
		<div class="col span_1_of_5"><br></div>
	</div>
