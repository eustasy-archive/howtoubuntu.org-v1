...
<div class="content">
	...
	<div class="section group">
		...
		<div class="col span_6_of_11">
			<p>After <a href="http://howtoubuntu.org/how-to-install-18-04-bionic-beaver">Installing Ubuntu 18.04 Bionic Beaver</a>, there are a wealth of things that need to be dealt with, including Hardware Drivers, DVD, Audio and Video Codecs, Archiving formats, generally useful stuff.</p>
...
wget -O - http://download.videolan.org/pub/debian/videolan-apt.asc|sudo apt-key add -</textarea>
	...
	<div class="section group">
		...
		<div class="col span_1_of_11"><br></div>
		<div class="col span_6_of_11">
			<!-- TODO Some of these may be out of date or uninstallable, test them -->
			<textarea class="left code resize">sudo apt install synaptic vlc gimp gimp-data gimp-plugin-registry gimp-data-extras y-ppa-manager bleachbit openjdk-7-jre oracle-java8-installer flashplugin-installer unace unrar zip unzip p7zip-full p7zip-rar sharutils rar uudeview mpack arj cabextract file-roller libxine1-ffmpeg mencoder flac faac faad sox ffmpeg2theora libmpeg2-4 uudeview libmpeg3-1 mpeg3-utils mpegdemux liba52-dev mpeg2dec vorbis-tools id3v2 mpg321 mpg123 libflac++6 totem-mozilla icedax lame libmad0 libjpeg-progs libdvdcss2 libdvdread4 libdvdnav4 libswscale-extra-2 ubuntu-restricted-extras ubuntu-wallpapers*</textarea>
		</div>
	</div>
	<br>
	<div class="section group">
...
sudo apt -y clean</textarea>
	...
	<div class="section group">
		<div class="col span_5_of_11">
			...
			<p class="textcenter"><a href="http://howtoubuntu.org/about-ubuntu-18-04-bionic-beaver" target="_blank">About Ubuntu 18.04 Bionic Beaver</a></p>
