<?php
	...
	$Description_HTML = '<p>The lovely <a target="_blank" href="https://www.youtube.com/nixiedoeslinux">NixiePixel</a> has a video on Resizing and Dual Booting Ubuntu.</p><h3 class="textcenter"><a class="download fancybox-media" href="https://www.youtube.com/embed/eSMMs4cfMqY?autohide=1&showinfo=0">Play Video</a></h3>';
...
if ($Request['path'] === $Place['path'].$Canonical) {
	...
	<div class="section group">
		...
		<div class="col span_3_of_5">
			...
			<p>The lovely <a target="_blank" href="https://www.youtube.com/nixiedoeslinux">NixiePixel</a> has a video on Resizing and Dual Booting Ubuntu.</p>
			<h3 class="textcenter"><a class="download fancybox-media" href="https://www.youtube.com/embed/eSMMs4cfMqY?autohide=1&showinfo=0">Play Video</a></h3>
