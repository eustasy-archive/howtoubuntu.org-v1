<?php
	...
	$Video = '<p><a href="https://www.youtube.com/user/TheLinuxFoundation">The Linux Foundation</a> have an amazing video about just how Linux, the base of ubuntu and many other free systems, is built.</p><h3><a class="download fancybox-media" href="http://www.youtube.com/embed/yVpbFMhOAwE?autohide=1&showinfo=0">Play Video</a></h3>';
...
if (htmlentities($Request['path'], ENT_QUOTES, 'UTF-8') == '/' . $Canonical) {
	...
	<div class="section group">
		...
		<div class="col span_1_of_3">
			...
			<h3><a class="download fancybox-media" href="http://www.youtube.com/embed/yVpbFMhOAwE?autohide=1&showinfo=0">Play Video</a></h3>
		</div>
		<div class="col span_1_of_3"><br></div>
	</div>
