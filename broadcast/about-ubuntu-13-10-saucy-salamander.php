...
if (htmlentities($Request['path'], ENT_QUOTES, 'UTF-8') == '/' . $Canonical) {
	...
	<h2 id="naming">Naming Ubuntu Releases</h2>
	<div class="section group">
		<div class="col span_1_of_4">
			<h3 id="numbers">Numbers</h3>
			<p>So the numbers part is easy, 12.04 was released on the 4th month of the 2012. Ubuntu 13.10 was released on the 10th month (October) of 2013. Releases are every six months so the will go 12.04, 12.10, 13.04, 13.10, 14.04, and so on.</p>
	...
	<div class="section group">
		<div class="col span_1_of_2">
			...
			<p>Ubuntu 13.10 Saucy Salamander was released on 17th of October 2013, and future releases will reoccur every 6 months (you can upgrade as easily as updating, it just takes a little longer) in April and October.</p>
		</div>
		<div class="col span_1_of_2">
			<h2 id="lts">Support</h2>
			<p>Ubuntu 13.10 is the first version to have only 9 months of support, with previous releases offering 18 months as a minimum. This comes after the upgrade to five years of support of the last LTS release, Ubuntu 12.04.</p>
		</div>
	</div>
