...
<div class="content">
	...
	<div class="section group">
		...
		<div class="col span_1_of_11"><br></div>
		<div class="col span_6_of_11">
			<a class="fancybox" href="assets/images/things-to-do-after-installing-ubuntu-14-04-trusty-tahr/1-enable-partners-repositories.png"><img class="round" src="assets/images/things-to-do-after-installing-ubuntu-14-04-trusty-tahr/1-enable-partners-repositories.png"></a>
		</div>
	</div>
	<br>
	<div class="section group">
...
wget -O - http://download.videolan.org/pub/debian/videolan-apt.asc|sudo apt-key add -</textarea>
	...
	<div class="section group">
		...
		<div class="col span_1_of_11"><br></div>
		<div class="col span_6_of_11">
			<a class="fancybox" href="assets/images/things-to-do-after-installing-ubuntu-14-04-trusty-tahr/8-additional-drivers.png"><img class="round" src="assets/images/things-to-do-after-installing-ubuntu-14-04-trusty-tahr/8-additional-drivers.png"></a>
		</div>
	</div>
	<br>
	<div class="section group">
