...
<head>
	...
	<link rel="stylesheet" media="screen" href="//cdn.jsdelivr.net/fancybox/2.1.5/jquery.fancybox.min.css">
	...
	<!--[if lt IE 9]>
		<script>jQl.loadjQ('//cdn.jsdelivr.net/g/modernizr,selectivizr,jquery@1.11.0,fancybox,jquery.autosize,jquery.equalize');</script>
	<![endif]-->
	<!--[if IE 9]><!-->
		<script>jQl.loadjQ('//cdn.jsdelivr.net/g/modernizr,jquery,fancybox,jquery.autosize,jquery.equalize');</script>
	<!--<![endif]-->

	<!-- Fancybox -->
	<script>
		jQl.loadjQdep('//cdn.jsdelivr.net/fancybox/2.1.5/helpers/jquery.fancybox-media.min.js');
		$(function(){
			$('.fancybox').fancybox();
