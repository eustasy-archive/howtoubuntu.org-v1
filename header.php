...
<head>
	...
	<!--[if lt IE 9]>
		<script>jQl.loadjQ('//cdn.jsdelivr.net/g/selectivizr,modernizr,jquery@1.11.0,colorbox,jquery.autosize,jquery.equalize');</script>
	<![endif]-->
	<!-- Else, just play it cool and load stuff -->
	<!--[if IE 9]><!-->
		<script>jQl.loadjQ('//cdn.jsdelivr.net/g/modernizr,jquery,colorbox,jquery.autosize,jquery.equalize');</script>
	<!--<![endif]-->
